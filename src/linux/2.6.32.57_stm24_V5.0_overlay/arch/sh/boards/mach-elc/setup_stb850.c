/*
 * arch/sh/boards/st/stb/elc/setup_stb850.c
 *
 * Copyright (C) 2013 Elecard-STB
 * Author: Anton Sergeev (Anton.Sergeev@elecard.ru)
 *
 * May be copied or modified under the terms of the GNU General Public
 * License.  See linux/COPYING for more information.
 *
 * Elecards stb850 support.
...
static void stb850_power_off(void)
{
	stpio_request_set_pin(11, 0, "standby", STPIO_OUT, 1);
}

int __init device_init_stb850(int ver)
{
	struct sysconf_field *sc;

	pm_power_off = stb850_power_off;
