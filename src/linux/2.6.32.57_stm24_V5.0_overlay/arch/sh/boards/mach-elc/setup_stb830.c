...
static struct stm_nand_config stm_nand_device_flex = {
	.driver = stm_nand_afm,
	.nr_banks = 1,
...
static struct stm_nand_config stm_nand_device_emi_csb = {
	.driver = stm_nand_emi,
	.nr_banks = 1,
	.banks = &(struct stm_nand_bank_data) {
		.csn		= 1,
...
/*static struct stm_nand_config stm_nand_device_emi_csc = {
	.driver = stm_nand_emi,
	.nr_banks = 1,
	.banks = &(struct stm_nand_bank_data) {
		.csn		= 2,
...
//		((struct stm_plat_nand_emi_data *)(nand_device_emi_b.dev.platform_data))->wait_active_low = 0;
	...
	stx7105_configure_nand(&stm_nand_device_emi_csb);
//	stx7105_configure_nand(&stm_nand_device_emi_csc);//SergA: fix registering second nand

	stx7105_configure_nand(&stm_nand_device_flex);
