...
QT_CONFIGURE+= -no-xmlpatterns -no-exceptions
endif
...
ifneq ($(BR2_INET_IPV6),y)
	...
	$(SED) '/QMAKE_LFLAGS/d' $(QT_QMAKE_CONF)
	$(SED) '/include.*qws.conf/aQMAKE_LFLAGS = -Wl,-rpath-link,$(STAGING_DIR)/usr/lib' $(QT_QMAKE_CONF)
