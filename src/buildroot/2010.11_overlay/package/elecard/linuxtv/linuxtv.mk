...
LINUXTV_SOURCE_LINK := $(BUILD_DIR)/linuxtv
...
define LINUXTV_DOWNLOAD_LINUXTV_MEDIA
	...
	rm -f $(LINUXTV_SOURCE_LINK)
	ln -s $(LINUXTV_BASE_NAME) $(LINUXTV_SOURCE_LINK)
endef

LINUXTV_PRE_CONFIGURE_HOOKS += LINUXTV_DOWNLOAD_LINUXTV_MEDIA
