...
ELECARD_MODULES_PRIV_DEPENDENCIES += linuxtv
endif
...
ELECARD_MODULES_PRIV_VERSION:=$(MODULES_ELECARD_PACK_VERSION)
ELECARD_MODULES_PRIV_SOURCE:=modules-elecard-$(ELECARD_MODULES_PRIV_VERSION).tar.gz
