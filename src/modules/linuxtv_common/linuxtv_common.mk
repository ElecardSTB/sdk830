...
MEDIA_BUILD := $(ROOTFS_OUTPUT_DIR)/build/media_build
ADD_LINUXTV_ENV := n
...
get_linuxtv_config_variable = $(if $(call get_rootfs_config_variable,BR2_PACKAGE_LINUXTV),$(call get_config_variable,$1,$(MEDIA_BUILD)/v4l/.config))
